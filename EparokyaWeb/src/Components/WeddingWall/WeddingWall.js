    ...
    <div className="weddingWall-container">
      ...
      <div className="weddingWall-content">
        {weddings.map((wedding, index) => {
          const formattedWeddingDate = new Date(
            wedding.weddingDate
          ...
          const formattedWeddingTime = new Date(
            `1970-01-01T${wedding.weddingTime}`
          ...
          const formattedConfirmedAt = new Date(
            wedding.confirmedAt
          ).toLocaleDateString("en-US", {
            month: "long",
            day: "numeric",
          ...
          const groomImageUrl =
            wedding.GroomOneByOne?.url || "/path/to/default-groom-image.jpg";
          const brideImageUrl =
            wedding.BrideOneByOne?.url || "/path/to/default-bride-image.jpg";
          ...
          return (
            <div key={index} className="weddingWall-box">
              ...
              <div className="weddingWall-body">
                <p className="weddingWall-names">
                  {wedding.groomName} & {wedding.brideName}
                </p>
                <p>
                  <strong>Wedding Date:</strong> {formattedWeddingDate}
                </p>
                <p>
                  <strong>Wedding Time:</strong> {formattedWeddingTime}
                </p>
                <p>
                  <strong>Confirmed Date:</strong> {formattedConfirmedAt}
                </p>
              </div>
