...
const MissionsPage = () => {
  ...
  const handleCardClick = (id) => navigate(`/missionsPageDetail/${id}`);
            ...
            <CardContent sx={{ flex: 1 }}>
              ...
              <Stack direction="row" spacing={1} mb={1} flexWrap="wrap">
                <Chip
                  label={
                    mainMission.Date
                      ? new Date(mainMission.Date).toLocaleDateString()
                      : ""
                  }
                  color="primary"
                  size="small"
                ...
                <Chip
                  ...
                  avatar={
                    <Avatar>
                      {mainMission.Author?.replace(/<i>|<\/i>/g, "").charAt(0)}
                    </Avatar>
                  }
                />
                <Chip
              ...
              <Typography variant="body2" color="text.secondary" gutterBottom>
                <b>Ministries:</b>{" "}
                {mainMission.Ministry?.length
                  ? mainMission.Ministry.map((m) => (typeof m === "object" ? m.name : m)).join(", ")
                  : "None"}
              </Typography>
