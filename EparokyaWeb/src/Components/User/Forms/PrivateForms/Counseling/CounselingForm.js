            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    handleChange(e, "contactPerson.contactNumber")
                  }
                  required
                />
              </Grid>
            ...
            <Grid item xs={12}>
              <FormControl fullWidth required>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    handleChange(e, "contactPerson.relationship")
                  }
                  label="Relationship"
                >
                  ...
                  <MenuItem value="Relative/Kamag-anak">
                    Relative/Kamag-anak
                  </MenuItem>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    handleChange(e, "address.LotBlockPhaseHouseNo")
                  }
                  required
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    handleChange(e, "address.SubdivisionVillageZone")
                  }
                  required
                />
              </Grid>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth required>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleBarangayChange(e, "address.barangay")
                    }
                  >
