...
import BaptismCalendar from "./BaptismCalendar";
import { Box, Paper, IconButton, Fade, Button, Typography } from "@mui/material";
import CloseIcon from "@mui/icons-material/Close";

const ConfirmedBaptismOverlay = ({ show, onClose }) => {
    if (!show) return null;
...
export default ConfirmedBaptismOverlay;
