...
const FuneralDetails = () => {
  ...
  const handleCancel = async () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || "Failed to cancel the funeral."
      );
    }
  };
    ...
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        >
          ...
          >
            <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
              ...
              <Stack spacing={1.5}>
                <Typography>
                  <strong>Name:</strong> {funeralDetails?.name || "N/A"}
                </Typography>
                <Typography>
                  <strong>Age:</strong> {funeralDetails?.age || "N/A"}
                </Typography>
                <Typography>
                  <strong>Contact Person:</strong>{" "}
                  {funeralDetails?.contactPerson || "N/A"}
                </Typography>
                <Typography>
                  <strong>Relationship:</strong>{" "}
                  {funeralDetails?.relationship || "N/A"}
                </Typography>
                <Typography>
                  <strong>Phone:</strong> {funeralDetails?.phone || "N/A"}
                </Typography>
                ...
                <Typography>
                  ...
                  {funeralDetails?.address?.BldgNameTower || "N/A"}
                </Typography>
                <Typography>
                  <strong>Lot/Block/Phase/House No.:</strong>{" "}
                  {funeralDetails?.address?.LotBlockPhaseHouseNo || "N/A"}
                </Typography>
                <Typography>
                  <strong>Subdivision/Village/Zone:</strong>{" "}
                  {funeralDetails?.address?.SubdivisionVillageZone || "N/A"}
                </Typography>
                <Typography>
                  <strong>Street:</strong>{" "}
                  {funeralDetails?.address?.Street || "N/A"}
                </Typography>
                <Typography>
                  <strong>Barangay:</strong>{" "}
                  {funeralDetails?.address?.barangay === "Others"
                    ? funeralDetails?.address?.customBarangay || "N/A"
                    : funeralDetails?.address?.barangay || "N/A"}
                </Typography>
                <Typography>
                  <strong>District:</strong>{" "}
                  {funeralDetails?.address?.District || "N/A"}
                </Typography>
                <Typography>
                  <strong>City:</strong>{" "}
                  {funeralDetails?.address?.city === "Others"
                    ? funeralDetails?.address?.customCity || "N/A"
                    : funeralDetails?.address?.city || "N/A"}
                </Typography>
                ...
                <Typography>
                  ...
                  {funeralDetails?.placeOfDeath || "N/A"}
                </Typography>
                <Typography>
                ...
                <Typography>
                  <strong>Time:</strong> {funeralDetails?.funeraltime || "N/A"}
                </Typography>
                <Typography>
                  <strong>Service Type:</strong>{" "}
                  {funeralDetails?.serviceType || "N/A"}
                </Typography>
                <Typography>
                  <strong>Priest Visit:</strong>{" "}
                  {funeralDetails?.priestVisit || "N/A"}
                </Typography>
                <Typography>
                  <strong>Reason of Death:</strong>{" "}
                  {funeralDetails?.reasonOfDeath || "N/A"}
                </Typography>
                ...
                <Typography>
                  <strong>Funeral Mass Date:</strong>{" "}
                ...
                <Typography>
                  <strong>Funeral Mass Time:</strong>{" "}
                  {funeralDetails?.funeralMasstime || "N/A"}
                </Typography>
                <Typography>
                  <strong>Funeral Mass:</strong>{" "}
                  {funeralDetails?.funeralMass || "N/A"}
                </Typography>
                <Typography>
                  <strong>Funeral Status:</strong>{" "}
                  {funeralDetails?.funeralStatus || "N/A"}
                </Typography>
                <Typography>
                ...
                {funeralDetails?.placingOfPall?.by && (
                  <Typography>
                    <strong>Placing of Pall by:</strong>{" "}
                    {funeralDetails.placingOfPall.by}
                  </Typography>
                )}
                {funeralDetails?.placingOfPall?.familyMembers?.length > 0 && (
                  <Typography>
                    <strong>Family Members Placing Pall:</strong>{" "}
                    {funeralDetails.placingOfPall.familyMembers.join(", ")}
                  </Typography>
                )}
              </Stack>
            </Paper>
                        ...
                        isImageFile(funeralDetails[doc].url) ? (
                          <>
                            <CardMedia
                              ...
                              onClick={() =>
                                openFileModal(funeralDetails[doc].url)
                              }
                            />
                            <Button
                              onClick={() =>
                          ...
                          >
                            ...
                            <Button
                              onClick={() =>
                                window.open(funeralDetails[doc].url, "_blank")
                              }
                              variant="contained"
                              startIcon={<FullscreenIcon />}
                            >
          ...
          >
                ...
                comments.map((comment, index) => (
                  ...
                  >
                    ...
                    {comment?.additionalComment && (
                      <Typography>
                        <strong>Details:</strong> {comment.additionalComment}
                      </Typography>
                    )}
                  </Box>
                ))
            ...
            <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
              ...
              <Typography sx={{ mb: 2 }}>
                {updatedFuneralDate
                  ? new Date(updatedFuneralDate).toLocaleDateString()
                  : "N/A"}
              </Typography>
            ...
            <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
              ...
              {funeralDetails?.Priest ? (
                <Typography>{funeralDetails.Priest.fullName}</Typography>
              ) : (
            ...
            {!user?.isPriest && (
              <Paper elevation={3} sx={{ p: 3 }}>
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      `/adminChat/${funeralDetails?.userId?._id}/${funeralDetails?.userId?.email}`
                    )
                  }
                  fullWidth
                >
        ...
        >
          ...
          <DialogContent>
            <Typography>
              Are you sure you want to confirm this funeral?
            </Typography>
          </DialogContent>
          <DialogActions>
