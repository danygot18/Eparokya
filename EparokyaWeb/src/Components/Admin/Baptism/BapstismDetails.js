...
const BaptismDetails = () => {
  ...
  useEffect(() => {
    const fetchBaptismDetails = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_API}/api/v1/getBaptism/${baptismId}`,
  ...
  const handleConfirm = async () => {
    try {
      ...
      toast.success("Baptism confirmed successfully!", {
    ...
    <div className="baptism-details-page">
                  ...
                  /\.(jpg|jpeg|png|gif|bmp|webp)$/i.test(
                    ...
                    <>
                      ...
                      >
                        <Box
                          ...
                          onClick={() =>
                            openModal(baptismDetails.Docs[doc].url)
                          }
                        />
                    ...
                    >
                      ...
                      <Typography
                        ...
                        sx={{ alignSelf: "flex-start" }} // aligns the caption with the iframe
                      >
                      ...
                      <Button
                        onClick={() =>
                          window.open(baptismDetails.Docs[doc].url, "_blank")
                        }
                        variant="contained"
                        sx={{
                          backgroundColor: "#d5edd9",
                          color: "black",
                          alignSelf: "flex-start", // aligns button to left; remove to center
                        }}
                      >
                        View Full File
                      </Button>
      ...
      <div className="baptism-details-box">
        <div className="wedding-date-box">
          ...
          <p className="date">
            {updatedBaptismDate
              ? new Date(updatedBaptismDate).toLocaleDateString()
              : "N/A"}
          </p>
        ...
        <div className="admin-comments-section">
          ...
          {baptismDetails?.adminNotes?.length > 0 ? (
            baptismDetails.adminNotes.map((note, index) => {
              ...
              const priestName = priestInfo
                ? `${priestInfo.title} ${priestInfo.fullName}`
                : "Unknown Priest";

              return (
                <div key={index} className="admin-comment">
                  <p>
                    <strong>Priest:</strong> {priestName}
                  </p>
                  {note.recordedBy && (
                    <p>
      ...
      <div className="wedding-checklist-container">
        ...
        >
          ...
          baptismDetails?.cancellingReason ? (
            <div
              className="house-comments-section"
