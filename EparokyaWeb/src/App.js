  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/user/SubmittedFormsNavigation"
          element={<SubmittedForms />}
          exact="true"
        />
        <Route
          path="/user/FormGuides"
          element={<UserFormGuides />}
          exact="true"
        />
        <Route
          path="/sentimentReports"
          element={<UserSentimentReports />}
          exact="true"
        />
        ...
        />
        <Route
          path="/user/funeralForm"
          element={<FuneralForm />}
          exact="true"
        />
        <Route
          path="/user/weddingForm"
          element={<WeddingForm />}
          exact="true"
        />
        <Route
          path="/user/counselingForm"
          element={<CounselingForm />}
          exact="true"
        />
        <Route
          path="/user/prayerRequest"
          element={<PrayerRequestForm />}
          exact="true"
        />
        <Route
          path="/user/houseBlessingForm"
          element={<HouseBlessingForm />}
          exact="true"
        />

        {/* Mass Forms */}
        <Route
          path="/user/massBaptism"
          element={<MassBaptismForm />}
          exact="true"
        />
        <Route
        ...
        />
        <Route
          path="/user/mySubmittedBaptismForm/:formId"
          element={<MySubmittedBaptismForm />}
          exact="true"
        />
        <Route
          path="/user/mySubmittedFuneralForm/:formId"
          element={<MySubmittedFuneralForm />}
          exact="true"
        />
        <Route
          path="/user/mySubmittedCounselingForm/:formId"
          element={<MySubmittedCounselingForm />}
          exact="true"
        />
        <Route
          path="/user/mySubmittedHouseBlessingForm/:formId"
          element={<MySubmittedHouseBlessingForm />}
          exact="true"
        />
        ...
        <Route
          path="/user/SubmittedWeddingList"
          element={<SubmittedWeddingList />}
          exact="true"
        />
        <Route
          path="/user/SubmittedBaptismList"
          element={<SubmittedBaptismList />}
          exact="true"
        />
        <Route
          path="/user/SubmittedFuneralList"
          element={<SubmittedFuneralList />}
          exact="true"
        />
        <Route
          path="/user/SubmittedCounselingList"
          element={<SubmittedCounselingList />}
          exact="true"
        />
        <Route
          path="/user/SubmittedHouseBlessingList"
          element={<SubmittedHouseBlessingList />}
          exact="true"
        />
        <Route
          path="/user/SubmittedPrayerWallList"
          element={<SubmittedPrayerWallList />}
          exact="true"
        />

        <Route
          path="/user/submittedFeedback"
        ...
        <Route
          path="/user/prayerRequestIntention"
          element={<PrayerRequestIntention />}
          exact="true"
        />
        ...
        />
        <Route
          path="/admin/EventSentimentDetails/:id"
          element={
            <ProtectedRoute isAdmin={true}>
              <EventSentimentDetails />
            </ProtectedRoute>
          }
        />
        ...
        />
        <Route
          path="/admin/PriestSentimentDetails/:id"
          element={
            <ProtectedRoute isAdmin={true}>
              <PriestSentimentDetails />
            </ProtectedRoute>
          }
        />
        ...
        />
        <Route
          path="/admin/ActivitytSentimentDetail/:id"
          element={
            <ProtectedRoute isAdmin={true}>
              <ActivitySentimentDetails />
            </ProtectedRoute>
          }
        />
        ...
        />
        <Route
          path="/admin/ministryCategoryDetails/:id"
          element={
            <ProtectedRoute isAdmin={true}>
              <MinistryCategoryDetails />
            </ProtectedRoute>
          }
        />
        ...
        />
        <Route
          path="/admin/counselingDetails/:counselingId"
          element={
            <ProtectedRoute isAdmin={true}>
              <CounselingDetails />
            </ProtectedRoute>
        ...
        <Route
          ...
          element={
            <ProtectedRoute isAdmin={true}>
              <PrayerIntentionsList />
            </ProtectedRoute>
          }
        />
        <Route
          path="/admin/prayerIntention/details/:prayerIntentionId"
          element={
            <ProtectedRoute isAdmin={true}>
              <PrayerIntentionDetails />
            </ProtectedRoute>
          }
        />
        ...
        />
        <Route
          path="/admin/houseBlessingDetails/:blessingId"
          element={
            <ProtectedRoute isAdmin={true}>
        ...
        <Route
          path="/admin/weddingDetails/:weddingId"
          element={
            <ProtectedRoute isAdmin={true}>
              <WeddingDetails />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/admin/baptismDetails/:baptismId"
          element={
            <ProtectedRoute isAdmin={true}>
              <BaptismDetails />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/admin/funeralDetails/:funeralId"
          element={
            <ProtectedRoute isAdmin={true}>
              <FuneralDetails />
            </ProtectedRoute>
        ...
        <Route
          path="/admin/weddingChecklist/:weddingId"
          element={
            <ProtectedRoute isAdmin={true}>
              <WeddingChecklist />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/admin/baptismChecklist/:baptismId"
          element={
            <ProtectedRoute isAdmin={true}>
              <BaptismChecklist />
            </ProtectedRoute>
        ...
        <Route
          path="/admin/massWeddingDetails/:massWeddingId"
          element={
            <ProtectedRoute isAdmin={true}>
              <MassWeddingDetailsForm />
            </ProtectedRoute>
          }
        />
        <Route
          path="/admin/massBaptismDetails/:massBaptismId"
          element={
            <ProtectedRoute isAdmin={true}>
              <MassBaptismDetailsForm />
            </ProtectedRoute>
          }
        />
