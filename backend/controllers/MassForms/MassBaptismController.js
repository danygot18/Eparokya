const Baptism = require('../../models/MassForms/massBinyag');
...
exports.getAllBaptisms = async (req, res) => {
    try {
        const baptisms = await Baptism.find().populate('baptismDateTime userId');
...
exports.getBaptismById = async (req, res) => {
    try {
        const baptism = await Baptism.findById(req.params.massBaptismId).populate('baptismDateTime userId');
        if (!baptism) {
