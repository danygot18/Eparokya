...
const communalBaptismSchema = new mongoose.Schema({

  baptismDateTime: { type: mongoose.Schema.Types.ObjectId, ref: 'adminDate' },
...
module.exports = mongoose.model('communalBaptism', communalBaptismSchema);