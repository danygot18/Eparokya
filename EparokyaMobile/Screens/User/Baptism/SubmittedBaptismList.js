            ...
            {loading ? (
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => {
                        const statusColor =
                            item.binyagStatus === "Confirmed" ? "green.500" :
                            item.binyagStatus === "Declined" ? "red.500" : "yellow.500";
                        ...
                        return (
                            <Pressable onPress={() => handleCardPress(item._id)}>
                                ...
                                >
                                    ...
                                    <VStack mt={2}>
                                        <Text><Text fontWeight="bold">Baptism Date:</Text> {item.baptismDate ? new Date(item.baptismDate).toLocaleDateString() : "N/A"}</Text>
                                        <Text><Text fontWeight="bold">Baptism Time:</Text> {item.baptismTime || "N/A"}</Text>
                                        <Text><Text fontWeight="bold">Parent Contact:</Text> {item.phone || "N/A"}</Text>
                                    </VStack>
                                </Box>
                            </Pressable>
                        );
