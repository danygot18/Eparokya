...
const SubmittedMassBaptismList = () => {
  ...
  const fetchMySubmittedForms = async () => {
    ...
    try {
      const response = await axios.get(
        `${baseURL}/massBaptism/getAllUserMassSubmittedBaptism`,
  ...
  const handleCardPress = (massBaptismId) => {
    navigation.navigate("MySubmittedMassBaptismForm", { massBaptismId });
  };
...
export default SubmittedMassBaptismList;
