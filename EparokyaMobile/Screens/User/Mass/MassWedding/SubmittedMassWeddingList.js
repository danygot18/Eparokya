...
const SubmittedMassWeddingList = () => {
  ...
  const fetchMySubmittedForms = async () => {
    ...
    try {
      const response = await axios.get(
        `${baseURL}/massWedding/getAllUserSubmittedWedding`,
  ...
  const handleCardClick = (massWeddingId) => {
    navigation.navigate("SubmittedMassWeddingDetails", { massWeddingId });
  };
...
export default SubmittedMassWeddingList;
