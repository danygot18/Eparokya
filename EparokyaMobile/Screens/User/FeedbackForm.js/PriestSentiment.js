...
const PriestSentiment = ({ navigation }) => {
    ...
    <ScrollView style={{ flex: 1, backgroundColor: "#fff" }}>
      <YStack space="$3" p="$4">
        <Text fontSize={24} fontWeight="bold" mb="$2">
          Priest Sentiment Feedback
        </Text>
        {activePriest ? (
          <Card p="$3" mb="$3" backgroundColor="#f7f7f7">
            <Text fontWeight="bold">
              Form Status:{" "}
              <Text color={activePriest.isActive ? "green" : "red"}>
                {activePriest.isActive ? "Active" : "Inactive"}
              </Text>
            </Text>
            <Text>
            ...
            <Text fontWeight="bold" mt="$2">
              Priest: {activePriest.typeId?.name || "N/A"}
            </Text>
          </Card>
        ) : (
          <Text color="red" mb="$2">
