...
const WeddingForm4 = ({ navigation, route }) => {
  ...
  useEffect(() => {
    console.log('User ID in Form 4:', userId);
  }, []);
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <TextInput placeholder="Ninong's Zip" value={ninongZip} onChangeText={setNinongZip} style={styles.input} keyboardType="numeric" />
      ...
      <TextInput placeholder="Ninang's Zip" value={ninangZip} onChangeText={setNinangZip} style={styles.input} keyboardType="numeric" />
